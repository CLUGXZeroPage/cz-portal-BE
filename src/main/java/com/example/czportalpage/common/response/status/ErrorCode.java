package com.example.czportalpage.common.response.status;

import com.example.czportalpage.common.response.BaseErrorCode;
import com.example.czportalpage.common.response.ErrorReasonDTO;
...
public enum ErrorCode implements BaseErrorCode {
    ...
    ACCOUNT_NOT_VALID(HttpStatus.BAD_REQUEST, "MEMBER4003", "유효하지 않은 계정입니다"),
    MEMBER_DUPLICATE(HttpStatus.BAD_REQUEST, "MEMBER4004", "이미 존재하는 사용자입니다."),
